...
export const TestMenuKUI = () => {
    ...
    const arregloItems2 = [{ icon: <FaPen />, text: "Texto 1", onClick: handleClick1}, {  icon: <IoMdSettings/ >, text: "Texto 2", onClick: handleClick2}, {  icon: <IoMdSettings/ >, text: "Texto 3", onClick: handleClick3}, {  icon: <IoMdSettings/ >, text: "Texto 3", onClick: handleClick3}, {  icon: <IoMdSettings/ >, text: "Texto 3", onClick: handleClick3}]
    return (
        <div>
            ...
            <MenuKUI marginLeft="500px" items={arregloItems2}  />
